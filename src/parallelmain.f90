program main
  ...
  if(res%model_parameters%slab_ocean_model_bool) then
    ...
    res%model_parameters%special_reservoirs = .False.
    res%model_parameters%num_special_reservoirs = 0
  endif 
  ...
  if(res%model_parameters%irank == 4) res%model_parameters%region_indices(1) = 954 !Use for mpirun with 6 processors
